...
public class Main
{
				...
				FileNotFoundException, UnsupportedEncodingException
	{
		...
		{
			PrintWriter writer = new PrintWriter("E:\\workspace\\glib\\src\\org\\asena\\agans\\ServiceInterface\\" + filename + "UCService.java", "UTF-8");
		
			writer.println("package org.asena.agans.ServiceInterface;");
			writer.println();
			writer.println("import org.asena.baseService.baseUCService;");
			writer.println("import org.asena.agans.Entity." + filename + ";");
			writer.println();
		...
		for (String filename : allfilenames)
		{
			PrintWriter writer = new PrintWriter("E:\\workspace\\glib\\src\\org\\asena\\agans\\Service\\" + filename + "ServiceImpl.java", "UTF-8");


			writer.println("package org.asena.agans.Service;");
			writer.println();
			writer.println("import org.asena.agans.ServiceInterface." + filename + "UCService;");
			writer.println("import org.asena.agans.Entity." + filename + ";");
